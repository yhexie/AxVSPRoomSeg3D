...
int main()
{
	...
	int err, line;
	ini_free(gamedb);
	gamedb = ini_read("configTraj.ini", &err, &line);
	...
	//参数设置
	AxInnerSphereGraphTraj innerSphereGraph;
	innerSphereGraph.setFilePath(t_path);//"D:\\Experiments\\A03Experiments\\scan1.txt";
